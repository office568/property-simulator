...
# 2. HELPER FUNCTIONS
# This function formats the large result numbers at the top and in charts
def fmt(number):
...
# SECTION 1: INITIAL INVESTMENT (Updated with Comma Formatting)
...
# SECTION 2: ROOM CONFIG (Updated with Comma Formatting)
