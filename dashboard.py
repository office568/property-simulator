...
def check_user():
    ...
    # Magic Link Logic (Handles Cron-job bypass)
    ...
    if "user_email" not in st.session_state:
        ...
        with st.container():
            ...
            with sec_col1:
                ...
                st.markdown("**👤 プライバシー分離**\nデータは各ユーザーごとに厳密に分離され、他者に公開されることはありません。")
            with sec_col2:
...
with col_be1:
    ...
    st.metric(label="貢献利益率", value=f"{round(cm_ratio)}%", help="売上100円につき、家賃等の固定費の支払いに回せる利益の割合です。")
