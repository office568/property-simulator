...
# 2. SYNC CALLBACK FUNCTIONS (To prevent the error you saw)
...
# 3. INITIALIZE SESSION STATE (Setting default values)
...
with st.sidebar.expander("1. 初期費用・準備期間設定", expanded=True):
    ...
    st.write("開業準備期間 (ヶ月)")
    prep_months = st.sidebar.slider("Prep Slider", 0, 6, 2, key="prep_slider", label_visibility="collapsed")
...
# Section 3: Operating Parameters (SAFE SYNC VERSION)
