...
with st.sidebar.expander("3. 運営コスト・稼働率設定", expanded=True):
    ...
    target_occ = c_occ1.slider("Slider", 10, 100, target_occ_val, label_visibility="collapsed", key="slider_occ")
    ...
    ota_fee_rate = c_ota1.slider("Slider", 0, 30, ota_fee_val, label_visibility="collapsed", key="slider_ota")
