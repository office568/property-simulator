...
with st.sidebar.expander("3. 運営コスト・稼働率設定", expanded=True):
    ...
    target_occ_val = c_occ2.number_input("Exact", value=70, min_value=10, max_value=100, step=1, label_visibility="collapsed", key="exact_occ")
    ...
    ota_fee_val = c_ota2.number_input("Exact", value=15, min_value=0, max_value=30, step=1, label_visibility="collapsed", key="exact_ota")
