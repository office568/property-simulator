...
with st.sidebar.expander("3. 運営コスト・稼働率設定", expanded=True):
    ...
    target_occ = c_occ1.slider("Slider", 10.0, 100.0, target_occ_val, label_visibility="collapsed", key="slider_occ")
    ...
    ota_fee_rate = c_ota1.slider("Slider", 0.0, 30.0, ota_fee_val, label_visibility="collapsed", key="slider_ota")
    ...
    cape_val = c_cape2.number_input("Exact", value=1.0, min_value=0.0, max_value=10.0, step=0.5, label_visibility="collapsed", key="exact_cape")
